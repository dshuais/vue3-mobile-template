 ...
 * @LastEditors: dushuai
 * @LastEditTime: 2023-03-24 15:00:09
...
export const useToast = () => {
   ...
   */
  const $loading = (message: string = '加载中...', duration: number = 0, loadingType: LoadingType = 'circular') => {
   ...
   * @returns Toast实例
   */
  const $msgSuccess = (msg: string = '成功') => {
